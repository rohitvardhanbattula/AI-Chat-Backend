...
const GITHUB_BASE         = '[https://raw.githubusercontent.com/SAP/abap-atc-cr-cv-s4hc/main/src](https://raw.githubusercontent.com/SAP/abap-atc-cr-cv-s4hc/main/src)';
...
module.exports = {
    GLOBAL_SYSTEM_INSTRUCTION, MAX_RETRIES, MAX_CHATS_PER_USER, MAX_PROMPTS_PER_SESSION,
    MAX_HISTORY_MESSAGES, CHARS_PER_TOKEN, MAX_INPUT_TOKENS, GPT_MAX_INPUT_TOKENS,
    CLAUDE_MAX_INPUT_TOKENS, MAX_OUTPUT_TOKENS_GPT, MAX_OUTPUT_TOKENS_CLAUDE,
    CLAUDE_MODEL_SIMPLE, CLAUDE_MODEL_COMPLEX, GENHUB_CLAUDE_DEPLOYMENT, GENHUB_GEMINI_DEPLOYMENT,
    ABAP_IGNORE_PHRASES, GITHUB_BASE, SAP_RELEASE_VERSION, ABAP_OBJECT_TYPE_PATTERNS,
    ABAP_PRIMITIVE_TYPES, RE_ABAP_VAR_PREFIX, RE_ABAP_KEYWORDS, RE_DIGITS_ONLY, SAP_ALWAYS_VALID_OBJECTS
};